...
namespace Example
{
	...
	private:
		...
		Microsoft::WRL::ComPtr<ID3D11Buffer>					m_constantBuffer_WVP;
		Microsoft::WRL::ComPtr<ID3D11Buffer>					m_CB_PBR;
		Microsoft::WRL::ComPtr<ID3D11Buffer>					m_CB_Light;
		...
		//常量缓冲区
		unique_ptr<SphereSceneConstantBuffer>					m_constantBufferData;
		unique_ptr<CB_PBR>										m_CB_PBRData;
		unique_ptr<CB_Light>									m_CB_LightData;
